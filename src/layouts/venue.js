...
export const VenueLayout = (venue) => {
  ...
  return `
        <section class="mt-16.5 lg:mt-26 lg:items-start px-main">
          <div>
            <svg class="w-7 h-5 lg:hidden">
                <use href="/sprite.svg#arrow-left"></use>
            </svg>

            <nav aria-label="Навигационная цепочка" class="hidden lg:block text-body-sm">
            ...
            <img src=${venue.shalePageImage} fetchpriority="high" class="w-full rounded-main mt-6 h-71.25 lg:h-107.5 object-cover lg:object-center" style="object-position: center 70%" />
