export const venues = [
  {
    ...
    price: 18750,
    description:
      "Зал «Шале» в центре Москвы на Мясницкой — идеальное пространство для проведения мероприятий. Просторное помещение в стиле лофт с высокими потолками и светлыми интерьерами создаст атмосферу уюта и роскоши для любого события.",
    homeImage: "/images/venues/shale_main.webp",
    shalePageImage: "/images/venues/shale/main.webp",
    amenities: [
      {
        icon: "square",
        title: "500м2",
